...
$(document).ready(function() {
	...
	$('#login_button').click(function(){
		...
		var enteredCode = $("#code").val().trim(); // 使用trim()方法删除空格
		var generatedCode = generatedVerificationCode.toString(); // 将生成的验证码转换为字符串
		...
		console.log(enteredCode, generatedCode); // 输出enteredCode和generatedCode的值到控制台
